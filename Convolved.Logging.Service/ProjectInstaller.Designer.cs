namespace Convolved.Logging.Service
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // logServiceInstaller
            // 
            this.logServiceInstaller.Description = "Writes log events and statistics to a database";
            this.logServiceInstaller.DisplayName = "Convolved Log Writer";
            this.logServiceInstaller.ServiceName = "LogService";
            this.logServiceInstaller.ServicesDependedOn = new string[] {
        "MSMQ"};
